...
const ProductDetailPage = () => {
  const { user, loading } = useAuth(); // Always call hooks at the top
        ...
        <div className="max-w-4xl mx-auto bg-white rounded-2xl shadow-lg overflow-hidden flex flex-col md:flex-row mb-10">
          ...
          <div className="md:w-1/2 p-6 flex flex-col justify-between">
            <div>
              ...
              <p className="text-2xl text-green-700 mt-2 font-bold">
                ₹{product.price}
              </p>
              <p className="text-[16px] text-gray-800 font-semibold mt-1">
